...
image:https://img.shields.io/travis/hanspr/tcell.svg?label=linux[Linux Status,link="https://travis-ci.org/hanspr/tcell"]
image:https://img.shields.io/appveyor/ci/hanspr/tcell.svg?label=windows[Windows Status,link="https://ci.appveyor.com/project/hanspr/tcell"]
image:https://img.shields.io/badge/license-APACHE2-blue.svg[Apache License,link="https://github.com/hanspr/tcell/blob/master/LICENSE"]
image:https://img.shields.io/badge/godoc-reference-blue.svg[GoDoc,link="https://godoc.org/github.com/hanspr/tcell"]
image:https://goreportcard.com/badge/hanspr/tcell[Go Report Card,link="http://goreportcard.com/report/hanspr/tcell"]
image:https://img.shields.io/discord/639503822733180969?label=discord[Discord,link="https://discord.gg/urTTxDN"]
image:https://codecov.io/gh/hanspr/tcell/branch/master/graph/badge.svg[codecov,link="https://codecov.io/gh/hanspr/tcell"]
